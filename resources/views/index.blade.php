...
<head>
    ...
    <meta name="author" content="Momen Rami">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="{{ url()->current() }}">
    <meta property="og:title" content="Momen Rami | {{ __('home.hero.title') }}">
    <meta property="og:description" content="{{ __('home.seo.description') }}">
    <meta property="og:image" content="{{ asset('assets/images/file_0000000044cc7243ae56e37cd49e7e59.png') }}">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ url()->current() }}">
    <meta property="twitter:title" content="Momen Rami | {{ __('home.hero.title') }}">
    <meta property="twitter:description" content="{{ __('home.seo.description') }}">
    <meta property="twitter:image" content="{{ asset('assets/images/file_0000000044cc7243ae56e37cd49e7e59.png') }}">
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset('assets/images/loge1.png') }}">
...
<body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-lg-5">
            <div class="container-fluid">
                <a class="navbar-brand logo" href="#">
                    <img src="{{ asset('assets/images/loge1.png') }}" alt="Logo" class="logo-img">
            ...
            <div class="row align-items-center flex-column-reverse flex-lg-row">
                <div class="col-lg-7 home-content">
                    ...
                    <div class="btn-box">
                        ...
                        <a href="{{ asset('assets/momen-cv/Momen_Rami_CV.pdf') }}" class="btn" target="_blank">{{ __('home.hero.cv') }}</a>
                    </div>

                    <div class="home-social mt-5">
                        <a href="https://www.facebook.com/share/1XXULh7v3q/" target="_blank"
                            rel="noopener noreferrer"><i class="fab fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/mo__0men?igsh=MXJ5cXA5c2EyMjFkMw==" target="_blank"
                            rel="noopener noreferrer"><i class="fab fa-instagram"></i></a>
                        <a href="https://x.com/momen_rami18269/" target="_blank" rel="noopener noreferrer"><i
                                class="fab fa-twitter"></i></a>
                        <a href="https://www.linkedin.com/in/mo-men-rami-46aa80291?utm_source=share_via&utm_content=profile&utm_medium=member_android"
                ...
                <div class="col-lg-5 home-img-container">
                    <div class="home-img">
                        <img src="{{ asset('assets/images/file_0000000044cc7243ae56e37cd49e7e59.png') }}"
                            alt="Portrait" class="portrait-img img-fluid">
        ...
        <div class="container">
            ...
            <div class="row align-items-center text-center text-lg-start">
                <div class="col-lg-5 d-flex justify-content-center mb-5 mb-lg-0">
                    <div class="about-img">
                        <img src="{{ asset('assets/images/74d36903-8ae6-4306-aa94-f2a0c1fa6681.jpg') }}" alt="Profile"
                            class="img-fluid">
    ...
    <section class="education" id="education">
        <div class="container">
            <h2 class="heading text-center mb-5">{{ __('home.resume.my') }}
                <span>{{ __('home.resume.title') }}</span></h2>
            <div class="row g-4">
                        ...
                        @foreach ($education as $item)
                            <div class="education-content mb-4 p-4 border border-info rounded-3 position-relative">
                                <div class="year text-info mb-2">
                                    ...
                                    {{ $item->end_date ? $item->end_date->format('Y') : __('home.resume.present') }}
                                </div>
    ...
    <section class="skills" id="skills">
        <div class="container">
            <h2 class="heading text-center mb-5">{{ __('home.skills.my') }}
                <span>{{ __('home.skills.title') }}</span></h2>
            <div class="row g-5">
                            ...
                            <div class="skills-content">
                                @foreach ($skillList as $skill)
                                    <div class="progress-item mb-4">
                                        <h5 class="d-flex justify-content-between">{{ $skill->name }}
                                            <span>{{ $skill->percentage }}%</span></h5>
    ...
    {{-- <section class="projects" id="projects" style="background: var(--bg-color); padding-bottom: 7rem;">
        <div class="container">
            <h2 class="heading text-center mb-5">{{ __('home.projects.latest') }}
                <span>{{ __('home.projects.title') }}</span></h2>
            <div class="row g-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card bg-transparent border-info h-100 project-card overflow-hidden">
                            ...
                            <div class="card-body text-white">
                                ...
                                <p class="card-text small text-secondary">{{ Str::limit($project->description, 100) }}
                                </p>
                                <div class="d-flex gap-2 mt-3">
                                    @if ($project->demo_url)
                                        <a href="{{ $project->demo_url }}" target="_blank"
                                            class="btn btn-sm btn-info">{{ __('home.projects.visit_site') }}</a>
                                    @endif
                                    @if ($project->github_url)
                                        <a href="{{ $project->github_url }}" target="_blank"
                                            class="btn btn-sm border-info text-white">{{ __('home.projects.github') }}</a>
                                    @endif
                                </div>
                            </div>
                        </div>
    ...
    <section class="contact" id="contact">
        <div class="container">
            <h2 class="heading text-center mb-5">{{ __('home.contact.contact') }}
                <span>{{ __('home.contact.title') }}</span></h2>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                <input type="text" name="name"
                                    class="form-control bg-transparent border-info text-white p-3"
    ...
    <footer class="footer">
        <div class="footer-social text-center mb-3">
            <a href="https://www.facebook.com/share/1XXULh7v3q/" target="_blank" rel="noopener noreferrer" class="mx-2 text-white"><i class="fab fa-facebook-f"></i></a>
            <a href="https://www.instagram.com/mo__0men?igsh=MXJ5cXA5c2EyMjFkMw==" target="_blank" rel="noopener noreferrer" class="mx-2 text-white"><i class="fab fa-instagram"></i></a>
            <a href="https://x.com/momen_rami18269/" target="_blank" rel="noopener noreferrer" class="mx-2 text-white"><i class="fab fa-twitter"></i></a>
            <a href="https://www.linkedin.com/in/mo-men-rami-46aa80291?utm_source=share_via&utm_content=profile&utm_medium=member_android" target="_blank" rel="noopener noreferrer" class="mx-2 text-white"><i class="fab fa-linkedin-in"></i></a>
            <a href="https://github.com/Momen-ai" target="_blank" rel="noopener noreferrer" class="mx-2 text-white"><i class="fab fa-github"></i></a>
        </div>
